          ...
          <table v-if="records.length" class="schedule-table">
            <thead >
              <tr  class="border-b border-gray-200 ">
                ...
                <th  class="font-moul text-left">ខ្លឹមសារ</th>
...
export default {
  ...
  setup(){
    ...
    const recordsPerSchedulePage = ref( Math.ceil( window.innerHeight / 100 ) )
...
@media screen and ( min-width: 50px ) and (max-width: 480px ) , screen and ( min-height: 100px ) and (max-height: 299px ) {
  ...
  @media screen and ( min-width: 769px ) and (max-width: 1024px ) , screen and ( min-height: 500px ) and (max-height: 699px ) {
    .schedule-header-panel {
      @apply h-10 text-gray-100 ;
    }
    .schedule-logo-panel {
    ...
    .schedule-caption {
      @apply h-10 py-2 px-1 flex-grow  leading-6 ;
      font-size: 1rem;
    }
    .digital-clock-panel {
      @apply flex-none text-right p-3 w-28;
    ...
    .schedule-table thead tr th {
      @apply text-sm font-normal text-gray-600 p-1 ;
    }
    .schedule-table .schedule-table-row {
    ...
    .schedule-table .meeting-status {
      @apply p-1 rounded-full text-white mx-auto w-20 shadow shadow-gray-700/70 ;
      font-size: 0.65rem;
    }
    .schedule-footer-panel {
      @apply fixed left-0 right-0 bottom-0 bg-blue-500 flex h-14 ;
  ...
  @media screen and (min-width: 3073px ) and (max-width: 4069px ) {
    .schedule-header-panel {
      @apply h-16 text-gray-100 p-1 ;
    }
    .schedule-logo-panel {
